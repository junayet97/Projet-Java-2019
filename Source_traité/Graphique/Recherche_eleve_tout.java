...
public class Recherche_eleve_tout extends JFrame implements ActionListener
{
    ...
    public Recherche_eleve_tout(Object[][] tab)
    {
        
        super("Informations Eleve___Recherche_eleve_tout.java");
        this.tab=tab;
        //Initialisation
        ...
        tableau.setModel(new javax.swing.table.DefaultTableModel(
            this.tab,
            new String [] {
                "ID Eleve", "Nom", "Prénom", "ID Inscription","Annee", "Classe"
            }
