...
public class Recherche_eleve_info extends JFrame implements ActionListener
{
    ...
    public Recherche_eleve_info(String num,String nom,String preno) 
    {
        super("Recherches Informations______Recherche_eleve_info.java____");
        ...
        annee.setText("Identifian eleve:");
        jPanel1.add(annee);
