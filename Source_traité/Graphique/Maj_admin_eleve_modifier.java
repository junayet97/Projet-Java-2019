...
public class Maj_admin_eleve_modifier  extends JFrame implements ActionListener
{
    ...
    public Maj_admin_eleve_modifier()
    {
        super("Mise à jour eleve___Maj_eleve_modifier.java__");
    ...
    /**
  * Modifie les info sur un eleve à partir de l'id de l'eleve
     * @param id_eleve id de l'eleve
     * @param nom nouveau nom
     * @param prenom nouveau prenom
     * @return  1 si c bon, 2 si l'eleve n'est pas trouvé*/
    
public int modif_eleve(int id_eleve,String nom, String prenom)
{   
    ...
    if (test==1) // si l'eleve existe
    {
       ...
       JOptionPane.showMessageDialog(jPanel1, "Modif echoué, l'éleve n'existe pas!");
    return 2;
    }
