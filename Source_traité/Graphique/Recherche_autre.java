...
public class Recherche_autre extends JFrame implements ActionListener 
{
    ...
    Object[][]tab_annee;
    Object[][]tab_enseignemnt;
    Object[][]tab_classe;
    Object[][]tab_discipline;
                                    
                            
    
    public Recherche_autre (Object[][]tab_annee,Object[][]tab_enseignement,Object[][]tab_classe,Object[][]tab_discipline)
    {
        super("Recherche d'information___Recherche_autre.java___");
        
        this.tab_annee=tab_annee;
        this.tab_enseignemnt=tab_enseignement;
        this.tab_classe=tab_classe;
        this.tab_discipline=tab_discipline;
