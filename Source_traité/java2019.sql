...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 09 juin 2019 à 00:43
...
CREATE TABLE IF NOT EXISTS `bulletin` (
  ...
  `moyenne_trimestre` double DEFAULT NULL,
...
INSERT INTO `bulletin` (`id_bulletin`, `id_trimestre`, `id_inscription`, `appreciation`, `moyenne_trimestre`) VALUES
(1, 2, 1, 'Peut Mieux Faire', NULL);
...
INSERT INTO `classe` (`id_classe`, `nom_classe`, `id_anneescolaire`, `id_niveau`) VALUES
(1, 'CE2 A', 2018, 2);
...
INSERT INTO `enseignement` (`id_ens`, `id_classe`, `id_discipline`, `id_personne`) VALUES
(2, 1, 2, 45);
...
(8, 'Bhuiyan', 'JuJu', 'eleve'),
(12, 'Giraudon', 'Mathilde', 'eleve'),
(45, 'Dupond', 'Marc', 'enseignant');
...
--
ALTER TABLE `classe`
  ADD CONSTRAINT `classe_ibfk_1` FOREIGN KEY (`id_anneescolaire`) REFERENCES `anneescolaire` (`id_anneescolaire`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `enseignement`
  ADD CONSTRAINT `enseignement_ibfk_10` FOREIGN KEY (`id_classe`) REFERENCES `classe` (`id_classe`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `enseignement_ibfk_11` FOREIGN KEY (`id_personne`) REFERENCES `personne` (`id_personne`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `enseignement_ibfk_9` FOREIGN KEY (`id_discipline`) REFERENCES `discipline` (`id_discipline`) ON DELETE CASCADE ON UPDATE CASCADE;
