 ...
 * @author mathi
 */
public class PPBUL extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PPBUL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
