...
public class Maj_prof_evaluation extends JFrame implements ActionListener
{
    ...
    public Maj_prof_evaluation()
    {
        super ("Mise à jour d'une évaluation___Maj_prof_evaluation.java___");
    ...
    public void actionPerformed(ActionEvent event) 
    {
        ...
        if (event.getSource() == buttonmodifier)
        {
            JOptionPane.showMessageDialog(jPanel1, "Disponible Prochainement!!!");
            //this.dispose();
            //new Maj_prof_eval_modifier();
        }
        if (event.getSource() == buttonsupprimer)
        {
            JOptionPane.showMessageDialog(jPanel1, "Disponible Prochainement!!!");
            //this.dispose();
            //new Maj_prof_eval_supprimer();
        }
