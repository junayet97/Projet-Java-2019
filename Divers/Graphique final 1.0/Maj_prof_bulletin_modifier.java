...
public class Maj_prof_bulletin_modifier extends JFrame implements ActionListener
{
    ...
    public Maj_prof_bulletin_modifier()
    {
        super("Mise à jour Bulletin____Maj_prof_modifier.java__");
        ...
        ptitre.setText("Modifier d' un champs du Bulltetin");
        jPanel1.add(ptitre);
        ptitre.setBounds(150, 110, 440, 44);
        ...
        buttonmodifier.setBounds(430, 280, 130, 31);
