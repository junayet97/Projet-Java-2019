...
public class Maj_admin_prof extends JFrame implements ActionListener
{
    ...
    public Maj_admin_prof()
    {
        super ("Mise à jour d'une prof___Maj_admin_prof.java___");
