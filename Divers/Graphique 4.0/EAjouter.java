...
public class EAjouter extends JFrame implements ActionListener
{
    ...
    public EAjouter()
    {
        super("Ajouter une Evaluation ...EAjouter.java");
        ...
        id.setText("Rentrer l'identifiant du détaille du bulletin :");
        jPanel1.add(id);
