 ...
 * @author mathi
 */
public class Mprof extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mprof.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
