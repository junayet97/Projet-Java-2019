...
{ 
    ...
    public co() 
    {
        JPanel jPanel1 = new JPanel(); // le panel cadre de la fenetre
        ...
        //image de fond
        fondimage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Graphique/Space.jpg"))); // NOI18N
    ...
    public void actionPerformed(ActionEvent event) 
    {
        ...
        {  
            ...
            {
                JOptionPane.showMessageDialog(fenetre, "Erreur : Nom de la BDD ou Mote de passe érroné"); 
            }
        }
        catch(Exception exc) 
        {
            JOptionPane.showMessageDialog(fenetre, "Erreur: BDD introuvable");
        }
    }
