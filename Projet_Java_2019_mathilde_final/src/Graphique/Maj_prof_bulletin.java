...
public class Maj_prof_bulletin extends JFrame implements ActionListener
{
    ...
    public Maj_prof_bulletin()
    {
        super ("Mise à jour Bulletin___Maj_prof_bulletin.java___");
        ...
        gtitre.setText(" Mise à jour Bulletins");
        jPanel1.add(gtitre);
        gtitre.setBounds(380, 30, 270, 40);
    ...
    public void actionPerformed(ActionEvent event) 
    {
        ...
        {
            this.dispose();
            new Maj_prof_bulletin_modifier();
        }
        if (event.getSource() == buttonsupprimer)
        {
            this.dispose();
            new Maj_prof_bulletin_supprimer();
        }
