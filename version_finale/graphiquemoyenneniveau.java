...
public class graphiquemoyenneniveau extends JFrame implements ActionListener 
{
    private JPanel page;
    private JButton buttonretour;
    
    public graphiquemoyenneniveau()
    {
        super ("graphique des moyennes selon les niveaux");
        ...
        titre.setText("graphique des moyennes selon les niveaux");
        page.add(titre);
