...
public class graphiquemoyenne extends JFrame implements ActionListener 
{
    private JPanel page;
    private JButton buttonretour;
    
    public graphiquemoyenne()
    {
        super ("graphiquemoyenne eleve.java");
        ...
        titre.setText("diagramme des notes de l'élèves");
        page.add(titre);
